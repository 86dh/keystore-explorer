 ...
 *  ├── kse.desktop                                  # Required by AppImage spec
 *  ├── kse.png                                      # Required by AppImage spec
 *  └── usr/
 *      ├── bin/
 *      │   └── kse -> ../lib/kse/kse.sh             # Symlink to launch script
 *      ├── lib/kse/
 *      │   ├── kse.jar                              # Main application JAR
 *      │   ├── kse.sh                               # Launch script
 ...
 *      │   │   ├── kse.txt
 *      │   │   └── ... (other licenses)
 *      │   └── jre/                                 # Bundled Java runtime (jlink)
 *      └── share/
 *          ├── applications/kse.desktop             # Desktop file
 *          ├── icons/hicolor/.../apps/kse.png       # Icons (multiple sizes)
 *          └── metainfo/org.kse.KeyStoreExplorer.metainfo.xml  # AppStream metadata
 */
